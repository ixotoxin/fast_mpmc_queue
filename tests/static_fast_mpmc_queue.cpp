...
TEST(lib_static_fast_mpmc_queue, queue_of_primitive) {
    static_fast_mpmc_queue<int, 40> queue {};
...
TEST(lib_static_fast_mpmc_queue, queue_of_struct) {
    struct payload {
        std::string m_str {};
        int m_int { 0 };
    ...
    static_fast_mpmc_queue<payload, 40> queue {};
...
TEST(lib_static_fast_mpmc_queue, order_test) {
    static_fast_mpmc_queue<int, 20> queue {};
