...
auto create_producer(
    xtxn::fast_mpmc_queue_type auto & queue,
...
template<xtxn::fast_mpmc_queue_type T>
...
void queue_test(std::string_view test_name, auto test_config) {
    ...
    queue_test<queue<50, 5'000>>(test_config.prelim_test_iters, test_config.prelim_test_items, test_config.set_d);

    std::cout << is_complete;

    queue_test<queue<1'000, 10'000>>(100ll, test_config.set_d, thin_separator);
    queue_test<queue<1'000, 10'000>>(1'000ll, test_config.set_d, thin_separator);
    queue_test<queue<1'000, 10'000>>(10'000ll, test_config.set_d, thin_separator);
    queue_test<queue<1'000, 10'000>>(100'000ll, test_config.set_d, thick_separator);

#ifndef _DEBUG

    std::cout << diff_size_and_attempts;

    queue_test<queue<10, 10'000, 1>>(1'000'000ll, test_config.set_a, thin_separator);
    queue_test<queue<10, 10'000, 100>>(1'000'000ll, test_config.set_a, thin_separator);
    queue_test<queue<100, 10'000, 1>>(1'000'000ll, test_config.set_a, thin_separator);
    queue_test<queue<100, 10'000, 100>>(1'000'000ll, test_config.set_a, thin_separator);
    queue_test<queue<1'000, 10'000, 1>>(1'000'000ll, test_config.set_a, thin_separator);
    queue_test<queue<1'000, 10'000, 100>>(1'000'000ll, test_config.set_a, thick_separator);

    std::cout << diff_workers_and_policies;

    queue_test<queue<100, 10'000, 10, queue_gp::call>>(1'000'000ll, test_config.set_a, thin_separator);
    queue_test<queue<100, 10'000, 10, queue_gp::round>>(1'000'000ll, test_config.set_a, thin_separator);
    queue_test<queue<100, 10'000, 10, queue_gp::step>>(1'000'000ll, test_config.set_a, thin_separator);

    queue_test<queue<100, 10'000, 10, queue_gp::call>>(1'000'000ll, test_config.set_b, thin_separator);
    queue_test<queue<100, 10'000, 10, queue_gp::round>>(1'000'000ll, test_config.set_b, thin_separator);
    queue_test<queue<100, 10'000, 10, queue_gp::step>>(1'000'000ll, test_config.set_b, thin_separator);

    queue_test<queue<100, 10'000, 10, queue_gp::call>>(1'000'000ll, test_config.set_c, thin_separator);
    queue_test<queue<100, 10'000, 10, queue_gp::round>>(1'000'000ll, test_config.set_c, thin_separator);
    queue_test<queue<100, 10'000, 10, queue_gp::step>>(1'000'000ll, test_config.set_c, thin_separator);

    queue_test<queue<100, 10'000, 10, queue_gp::call>>(1'000'000ll, test_config.set_d, thin_separator);
    queue_test<queue<100, 10'000, 10, queue_gp::round>>(1'000'000ll, test_config.set_d, thin_separator);
    queue_test<queue<100, 10'000, 10, queue_gp::step>>(1'000'000ll, test_config.set_d, thick_separator);
